...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Selector changed for Hotel page
    const bookButtons = document.querySelectorAll('.popular__card .book-now-btn');
    ...
    // Using same cart key to share state, or different? User likely wants shared state.
    // Let's use the same key 'homestay_cart' so items from apartments and hotels mix.
    ...
    bookButtons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            // Hotel Page Structure:
            // <div class="popular__card__header">
            //    <h4>Name</h4>
            //    <h4>$Price</h4>
            // </div>
            const headers = card.querySelectorAll('.popular__card__header h4');
            const title = headers[0].innerText;
            const priceText = headers[1].innerText; // "$536"
